...
/**
 * The type Low level heuristic. This abstract class is an implementation of a
 * Low-Level Heuristic (LowLevelHeuristic).
 */
public abstract class LowLevelHeuristic implements Serializable {
     ...
     * @param maxValues HashMap containing max values for random attributes
     * generation.
     ...
     *
     * @param allparameterAction an HashMap containing operators with its
     * parameters.
     */
    ...
    public String getName() {
        Object ax = crossover.getOp().getParameter("variant");
        String depart = "";
        if (ax != null) {
            depart = "_" + ((String) ax);
        }
        String toReturn = crossover.toString() + depart + "_" + mutation.toString();
        return toReturn;
    }

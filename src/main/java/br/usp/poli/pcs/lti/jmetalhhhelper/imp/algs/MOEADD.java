 ...
 * @author vinicius
 */
public class MOEADD<S extends Solution<?>> extends Moeadd<S> {
    ...
    protected double calcImprovement(S parent, TaggedSolution individual, int k) {
    ...
    protected double calcImprovement(List<S> parents, TaggedSolution individual, int cid) {

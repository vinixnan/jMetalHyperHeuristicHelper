...
/**
 * The type Polynomial muta. This class extends the jMetal mutation class and
 * implements Operator interface. This was created to use polymorphism without
 * changes jMetal mutation class.
 */
...
public class PolynomialMuta extends PolynomialMutation implements Operator {
     ...
     */
    public PolynomialMuta(double mutationProbability,
            double distributionIndex,
            RandomGenerator<Double> randomGenerator) {
        super(mutationProbability, distributionIndex, randomGenerator);
        parameters = new HashMap<>();
    }

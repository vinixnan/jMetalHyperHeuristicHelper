...
/**
 * Class representing problem CRE32. Source: Ryoji Tanabe and Hisao Ishibuchi,
...
public class CRE32 extends AbstractDoubleProblem {
    ...
    public void evaluate(DoubleSolution solution) {
        double x_L = solution.getVariableValue(0);
        double x_B = solution.getVariableValue(1);
        double x_D = solution.getVariableValue(2);
        double x_T = solution.getVariableValue(3);
        double x_Vk = solution.getVariableValue(4);
        double x_CB = solution.getVariableValue(5);

...
/**
 * Class representing problem RE41. Source: Ryoji Tanabe and Hisao Ishibuchi, An
...
public class RE41 extends AbstractDoubleProblem {
    ...
    public void evaluate(DoubleSolution solution) {
        ...
        double x5 = Math.rint(solution.getVariableValue(4));
        double x6 = Math.rint(solution.getVariableValue(5));
        double x7 = Math.rint(solution.getVariableValue(6));

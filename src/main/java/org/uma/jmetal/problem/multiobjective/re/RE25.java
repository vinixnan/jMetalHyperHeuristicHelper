...
/**
 * Class representing problem RE25. Source: Ryoji Tanabe and Hisao Ishibuchi, An
...
public class RE25 extends AbstractDoubleProblem {
    ...
    public void evaluate(DoubleSolution solution) {
        ...
        double x3 = getClosestValue(diameterFeasibleIntergers, solution.getVariableValue(2));

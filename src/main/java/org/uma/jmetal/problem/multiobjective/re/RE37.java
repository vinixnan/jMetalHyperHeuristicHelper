...
/**
 * Class representing problem RE37. Source: Ryoji Tanabe and Hisao Ishibuchi, An
...
public class RE37 extends AbstractDoubleProblem {
    ...
    public void evaluate(DoubleSolution solution) {
        double xAlpha = solution.getVariableValue(0);
        double xHA = solution.getVariableValue(1);
        double xOA = solution.getVariableValue(2);
        double xOPTT = solution.getVariableValue(3);

...
// The number of objectives
    protected final int GAA_Number_objectives = 10;

// The number of constraints
    protected final int GAA_Number_constraints = 1;

// The decision variable lower bounds
    protected final double GAA_Bounds_lower[] = {
        0.24, 7, 0, 5.5, 19, 85, 14, 3, 0.46,
        0.24, 7, 0, 5.5, 19, 85, 14, 3, 0.46,
        0.24, 7, 0, 5.5, 19, 85, 14, 3, 0.46};

// The decision variable upper bounds
    protected final double GAA_Bounds_upper[] = {
        0.48, 11, 6, 5.968, 25, 110, 20, 3.75, 1,
        0.48, 11, 6, 5.968, 25, 110, 20, 3.75, 1,
        0.48, 11, 6, 5.968, 25, 110, 20, 3.75, 1};

    protected OverallConstraintViolation<DoubleSolution> overallConstraintViolationDegree;
    protected NumberOfViolatedConstraints<DoubleSolution> numberOfViolatedConstraints;

    public Gaa() {
        setNumberOfVariables(GAA_Number_variables);
        setNumberOfObjectives(GAA_Number_objectives);
        setNumberOfConstraints(GAA_Number_constraints);
        List<Double> lowerLimit = Arrays.asList(ArrayUtils.toObject(GAA_Bounds_lower));
        List<Double> upperLimit = Arrays.asList(ArrayUtils.toObject(GAA_Bounds_upper));
    ...
    public void evaluateConstraints(DoubleSolution solution) {
        //It is already performed in solution evaluation
    }
    ...
    public void evaluate(DoubleSolution solution) {
        ...
        GAA_Evaluate(variables, obj, constraint);
        for (int i = 0; i < obj.length; i++) {
            solution.setObjective(i, obj[i]);
        }
        double overallConstraintViolation = constraint[0];
        int violatedConstraints = 0;
        if (constraint[0] <= 0.0) {//ver
            violatedConstraints++;
        }
...
//   obj - Output, the array of objectives
    ...
    /*
        @param 
     */
    public void GAA_Evaluate(double[] var, double[] obj, double[] constr) {
        ...
        double PFPF = Math.pow(
                Math.pow(CSPD2 - CSPDM, 2)
                + Math.pow(CSPD4 - CSPDM, 2)
                + Math.pow(CSPD6 - CSPDM, 2)
                + Math.pow(AR2 - ARM, 2)
                + Math.pow(AR4 - ARM, 2)
                + Math.pow(AR6 - ARM, 2)
                + Math.pow(SWEEP2 - SWEEPM, 2)
                + Math.pow(SWEEP4 - SWEEPM, 2)
                + Math.pow(SWEEP6 - SWEEPM, 2)
                + Math.pow(DPROP2 - DPROPM, 2)
                + Math.pow(DPROP4 - DPROPM, 2)
                + Math.pow(DPROP6 - DPROPM, 2)
                + Math.pow(WINGLD2 - WINGLDM, 2)
                + Math.pow(WINGLD4 - WINGLDM, 2)
                + Math.pow(WINGLD6 - WINGLDM, 2)
                + Math.pow(AF2 - AFM, 2)
                + Math.pow(AF4 - AFM, 2)
                + Math.pow(AF6 - AFM, 2)
                + Math.pow(SEATW2 - SEATWM, 2)
                + Math.pow(SEATW4 - SEATWM, 2)
                + Math.pow(SEATW6 - SEATWM, 2)
                + Math.pow(ELODT2 - ELODTM, 2)
                + Math.pow(ELODT4 - ELODTM, 2)
                + Math.pow(ELODT6 - ELODTM, 2)
                + Math.pow(TAPER2 - TAPERM, 2)
                + Math.pow(TAPER4 - TAPERM, 2)
                + Math.pow(TAPER6 - TAPERM, 2), 0.5);
...
//
//	double var1 = Math.pow(((
//		Math.pow((var[0] - x1), 2) + 
//		Math.pow((var[9] - x1), 2) + 
//		Math.pow((var[18] - x1), 2)) / 2), 0.5);
//	double var2 = Math.pow(((
//		Math.pow((var[1] - x2), 2) + 
//		Math.pow((var[10] - x2), 2) + 
//		Math.pow((var[19] - x2), 2)) / 2), 0.5);
//	double var3 = Math.pow(((
//		Math.pow((var[2] - x3), 2) + 
//		Math.pow((var[11] - x3), 2) + 
//		Math.pow((var[20] - x3), 2)) / 2), 0.5);
//	double var4 = Math.pow(((
//		Math.pow((var[3] - x4), 2) + 
//		Math.pow((var[12] - x4), 2) + 
//		Math.pow((var[21] - x4), 2)) / 2), 0.5);
//	double var5 = Math.pow(((
//		Math.pow((var[4] - x5), 2) + 
//		Math.pow((var[13] - x5), 2) + 
//		Math.pow((var[22] - x5), 2)) / 2), 0.5);
//	double var6 = Math.pow(((
//		Math.pow((var[5] - x6), 2) + 
//		Math.pow((var[14] - x6), 2) + 
//		Math.pow((var[23] - x6), 2)) / 2), 0.5);
//	double var7 = Math.pow(((
//		Math.pow((var[6] - x7), 2) + 
//		Math.pow((var[15] - x7), 2) + 
//		Math.pow((var[24] - x7), 2)) / 2), 0.5);
//	double var8 = Math.pow(((
//		Math.pow((var[7] - x8), 2) + 
//		Math.pow((var[16] - x8), 2) + 
//		Math.pow((var[25] - x8), 2)) / 2), 0.5);
//	double var9 = Math.pow(((
//		Math.pow((var[8] - x9), 2) + 
//		Math.pow((var[17] - x9), 2) + 
//		Math.pow((var[26] - x9), 2)) / 2), 0.5);
//
...
//	    	pvar8 + pvar9
        ...
        double NOISE2 = 74.099998 - 0.0004 * CSPD2 - 0.0156 * AR2 + 0.0003
                ...
                * TAPER2 + 0 * ELODT2 * TAPER2 + 0.0008 * Math.pow(CSPD2, 2)
                + 0.0016 * Math.pow(AR2, 2) + 0.0011 * Math.pow(SWEEP2, 2) + 0.1105
                * Math.pow(DPROP2, 2) + 0.0004 * Math.pow(WINGLD2, 2) - 0.0019
                * Math.pow(AF2, 2) + 0.0009 * Math.pow(SEATW2, 2) + 0.001
                * Math.pow(ELODT2, 2) + 0.0007 * Math.pow(TAPER2, 2);
        double WEMP2 = 1917 + 5.979 * CSPD2 + 35.130001 * AR2 - 0.7119 * SWEEP2
                ...
                * Math.pow(CSPD2, 2) - 1.812 * Math.pow(AR2, 2) + 1.173 * Math.pow(SWEEP2, 2)
                + 0.753 * Math.pow(DPROP2, 2) + 3.638 * Math.pow(WINGLD2, 2) + 0.133
                * Math.pow(AF2, 2) + 5.323 * Math.pow(SEATW2, 2) + 1.478 * Math.pow(ELODT2, 2)
                - 0.192 * Math.pow(TAPER2, 2);
        double DOC2 = 83.17 + 12.53 * CSPD2 - 0.0477 * AR2 - 0.0215 * SWEEP2
                ...
                * ELODT2 + 0.0047 * SEATW2 * TAPER2 - 0.003 * ELODT2 * TAPER2
                - 11.37 * Math.pow(CSPD2, 2) - 0.2836 * Math.pow(AR2, 2) - 0.3149
                * Math.pow(SWEEP2, 2) + 5.337 * Math.pow(DPROP2, 2) - 0.3711
                * Math.pow(WINGLD2, 2) - 0.071 * Math.pow(AF2, 2) - 0.2177
                * Math.pow(SEATW2, 2) - 0.2354 * Math.pow(ELODT2, 2) - 0.238
                * Math.pow(TAPER2, 2);
        double ROUGH2 = 2.197 - 0.0002 * CSPD2 + 0.1541 * AR2 - 0.0012 * SWEEP2
                ...
                * SEATW2 * TAPER2 + 0.0012 * Math.pow(CSPD2, 2) - 0.0273
                * Math.pow(AR2, 2) - 0.0048 * Math.pow(SWEEP2, 2) + 0.0033
                * Math.pow(DPROP2, 2) + 0.0062 * Math.pow(WINGLD2, 2) + 0.0021
                * Math.pow(AF2, 2) - 0.0016 * Math.pow(SEATW2, 2) - 0.0011
                * Math.pow(ELODT2, 2) - 0.0048 * Math.pow(TAPER2, 2);
        double WFUEL2 = 416.399994 - 6.093 * CSPD2 - 31.91 * AR2 + 0.7968
                ...
                * ELODT2 - 1.339 * SEATW2 * TAPER2 - 0.9311 * ELODT2 * TAPER2
                - 0.7538 * Math.pow(CSPD2, 2) + 1.13 * Math.pow(AR2, 2) - 1.078
                * Math.pow(SWEEP2, 2) - 5.989 * Math.pow(DPROP2, 2) - 3.043
                * Math.pow(WINGLD2, 2) + 0.0627 * Math.pow(AF2, 2) - 4.958
                * Math.pow(SEATW2, 2) - 1.41 * Math.pow(ELODT2, 2) + 0.3532
                * Math.pow(TAPER2, 2);
        double PURCH2 = 43280 + 133.1 * CSPD2 + 780.400024 * AR2 - 1.501
                ...
                * ELODT2 + 1.033 * AF2 * TAPER2 + 82.230003 * SEATW2 * ELODT2
                ...
                + 10.51 * Math.pow(CSPD2, 2) - 49.189999 * Math.pow(AR2, 2) + 26.51
                * Math.pow(SWEEP2, 2) + 35.310001 * Math.pow(DPROP2, 2) + 33.560001
                * Math.pow(WINGLD2, 2) + 10.66 * Math.pow(AF2, 2) + 74.309998
                * Math.pow(SEATW2, 2) + 8.461 * Math.pow(ELODT2, 2) - 0.7392
                * Math.pow(TAPER2, 2);
        double RANGE2 = 1971 - 6.807 * CSPD2 - 76.230003 * AR2 + 2.885 * SWEEP2
                ...
                * TAPER2 - 3.006 * ELODT2 * TAPER2 - 11.61 * Math.pow(CSPD2, 2)
                + 4.892 * Math.pow(AR2, 2) - 11.61 * Math.pow(SWEEP2, 2) - 84.110001
                * Math.pow(DPROP2, 2) + 65.389999 * Math.pow(WINGLD2, 2) - 7.108
                * Math.pow(AF2, 2) - 15.61 * Math.pow(SEATW2, 2) - 13.11 * Math.pow(ELODT2, 2)
                + 8.892 * Math.pow(TAPER2, 2);
        double LDMAX2 = 17.780001 + 0.4845 * CSPD2 + 1.625 * AR2 + 0.0267
                ...
                * ELODT2 - 0.0071 * SEATW2 * TAPER2 - 0.0059 * ELODT2 * TAPER2
                - 0.0897 * Math.pow(CSPD2, 2) - 0.1488 * Math.pow(AR2, 2) - 0.0116
                * Math.pow(SWEEP2, 2) - 0.0009 * Math.pow(DPROP2, 2) - 0.0305
                * Math.pow(ELODT2, 2) - 0.0009 * Math.pow(TAPER2, 2) + 0.0157
                * Math.pow(WINGLD2, 2) - 0.001 * Math.pow(AF2, 2) - 0.0577
                * Math.pow(SEATW2, 2);
        double VCMAX2 = 200.4 - 0.3799 * CSPD2 + 0.8236 * AR2 + 0.2168 * SWEEP2
                ...
                * ELODT2 - 0.046 * SEATW2 * TAPER2 - 0.0504 * ELODT2 * TAPER2
                - 0.1452 * Math.pow(CSPD2, 2) - 0.2937 * Math.pow(AR2, 2) + 0.0303
                * Math.pow(SWEEP2, 2) + 0.1378 * Math.pow(DPROP2, 2) - 0.6522
                * Math.pow(WINGLD2, 2) + 0.1378 * Math.pow(AF2, 2) - 0.6102
                * Math.pow(SEATW2, 2) - 0.3722 * Math.pow(ELODT2, 2) + 0.0303
                * Math.pow(TAPER2, 2);
        ...
        double NOISE4 = 74.099998 - 0.0005 * CSPD4 - 0.0158 * AR4 + 0.0003
                ...
                * SEATW4 * ELODT4 + 0.0008 * Math.pow(CSPD4, 2) + 0.0016
                * Math.pow(AR4, 2) + 0.0011 * Math.pow(SWEEP4, 2) + 0.1104
                * Math.pow(DPROP4, 2) + 0.0003 * Math.pow(WINGLD4, 2) - 0.0019
                * Math.pow(AF4, 2) + 0.001 * Math.pow(SEATW4, 2) + 0.001 * Math.pow(ELODT4, 2)
                + 0.0007 * Math.pow(TAPER4, 2);
        double WEMP4 = 1947 + 6.338 * CSPD4 + 33.869999 * AR4 - 0.448 * SWEEP4
                ...
                * Math.pow(CSPD4, 2) + 1.065 * Math.pow(AR4, 2) + 0.7346 * Math.pow(SWEEP4, 2)
                + 0.4896 * Math.pow(DPROP4, 2) + 5.815 * Math.pow(WINGLD4, 2) - 0.1304
                * Math.pow(AF4, 2) + 3.595 * Math.pow(SEATW4, 2) + 0.6296
                * Math.pow(ELODT4, 2) + 1.26 * Math.pow(TAPER4, 2);
        double DOC4 = 83.150002 + 12.02 * CSPD4 - 0.072 * AR4 - 0.0126 * SWEEP4
                ...
                * ELODT4 + 0.0048 * SEATW4 * TAPER4 - 0.0042 * ELODT4 * TAPER4
                - 10.95 * Math.pow(CSPD4, 2) - 0.2401 * Math.pow(AR4, 2) - 0.2203
                * Math.pow(SWEEP4, 2) + 5.223 * Math.pow(DPROP4, 2) - 0.2669
                * Math.pow(WINGLD4, 2) - 0.0884 * Math.pow(AF4, 2) - 0.2169
                * Math.pow(SEATW4, 2) - 0.306 * Math.pow(ELODT4, 2) - 0.2231
                * Math.pow(TAPER4, 2);
        double ROUGH4 = 2.191 - 0.0001 * CSPD4 + 0.1584 * AR4 - 0.0017 * SWEEP4
                ...
                * Math.pow(CSPD4, 2) - 0.0302 * Math.pow(AR4, 2) - 0.0015
                * Math.pow(SWEEP4, 2) + 0.0041 * Math.pow(DPROP4, 2) + 0.005
                * Math.pow(WINGLD4, 2) + 0.0029 * Math.pow(AF4, 2) + 0.0009
                * Math.pow(SEATW4, 2) - 0.0007 * Math.pow(ELODT4, 2) - 0.0058
                * Math.pow(TAPER4, 2);
        double WFUEL4 = 385.5 - 6.707 * CSPD4 - 30.57 * AR4 + 0.5048 * SWEEP4
                ...
                * Math.pow(CSPD4, 2) - 1.698 * Math.pow(AR4, 2) - 0.6064 * Math.pow(SWEEP4, 2)
                - 6.025 * Math.pow(DPROP4, 2) - 4.978 * Math.pow(WINGLD4, 2) + 0.2611
                * Math.pow(AF4, 2) - 3.229 * Math.pow(SEATW4, 2) - 0.4999
                * Math.pow(ELODT4, 2) - 1.068 * Math.pow(TAPER4, 2);
        double PURCH4 = 43730 + 142.5 * CSPD4 + 756.5 * AR4 + 2.004 * SWEEP4
                ...
                * TAPER4 - 1.456 * Math.pow(CSPD4, 2) + 16.049999 * Math.pow(AR4, 2)
                - 0.7055 * Math.pow(SWEEP4, 2) + 45.990002 * Math.pow(DPROP4, 2) + 87.14
                * Math.pow(WINGLD4, 2) + 0.8945 * Math.pow(AF4, 2) + 51.650002
                * Math.pow(SEATW4, 2) - 2.256 * Math.pow(ELODT4, 2) + 25.59
                * Math.pow(TAPER4, 2);
        double RANGE4 = 1941 - 6.768 * CSPD4 - 68.910004 * AR4 + 2.315 * SWEEP4
                ...
                * TAPER4 - 12.83 * Math.pow(CSPD4, 2) + 4.667 * Math.pow(AR4, 2) - 12.33
                * Math.pow(SWEEP4, 2) - 85.330002 * Math.pow(DPROP4, 2) + 57.169998
                * Math.pow(WINGLD4, 2) - 8.833 * Math.pow(AF4, 2) - 16.33
                * Math.pow(SEATW4, 2) - 13.33 * Math.pow(ELODT4, 2) + 8.167
                * Math.pow(TAPER4, 2);
        double LDMAX4 = 17.43 + 0.4811 * CSPD4 + 1.584 * AR4 + 0.0212 * SWEEP4
                ...
                * Math.pow(CSPD4, 2) - 0.1312 * Math.pow(AR4, 2) - 0.0127
                * Math.pow(SWEEP4, 2) - 0.0041 * Math.pow(DPROP4, 2) + 0.0304
                * Math.pow(WINGLD4, 2) - 0.0044 * Math.pow(AF4, 2) - 0.0545
                * Math.pow(SEATW4, 2) - 0.0239 * Math.pow(ELODT4, 2) + 0.0066
                * Math.pow(TAPER4, 2);
        double VCMAX4 = 197.800003 - 0.3562 * CSPD4 + 0.7729 * AR4 + 0.1807
                ...
                * ELODT4 - 0.039 * SEATW4 * TAPER4 - 0.0162 * ELODT4 * TAPER4
                - 0.1479 * Math.pow(CSPD4, 2) - 0.1989 * Math.pow(AR4, 2) - 0.2574
                * Math.pow(SWEEP4, 2) + 0.3991 * Math.pow(DPROP4, 2) - 0.5109
                * Math.pow(WINGLD4, 2) + 0.0706 * Math.pow(AF4, 2) - 0.4174
                * Math.pow(SEATW4, 2) - 0.2574 * Math.pow(ELODT4, 2) - 0.0384
                * Math.pow(TAPER4, 2);
        ...
        double NOISE6 = 74.099998 - 0.0004 * CSPD6 - 0.0156 * AR6 + 0.0003
                ...
                * SEATW6 * ELODT6 + 0.0006 * Math.pow(CSPD6, 2) + 0.0017
                * Math.pow(AR6, 2) + 0.0011 * Math.pow(SWEEP6, 2) + 0.1103
                * Math.pow(DPROP6, 2) + 0.0004 * Math.pow(WINGLD6, 2) - 0.0021
                * Math.pow(AF6, 2) + 0.001 * Math.pow(SEATW6, 2) + 0.001 * Math.pow(ELODT6, 2)
                + 0.0008 * Math.pow(TAPER6, 2);
        double WEMP6 = 1972 + 5.386 * CSPD6 + 33.290001 * AR6 - 0.0222 * SWEEP6
                ...
                * ELODT6 + 0.0969 * SEATW6 * TAPER6 - 0.1483 * ELODT6 * TAPER6
                + 1.446 * Math.pow(CSPD6, 2) - 2.524 * Math.pow(AR6, 2) + 1.646
                * Math.pow(SWEEP6, 2) + 1.381 * Math.pow(DPROP6, 2) + 2.651
                * Math.pow(WINGLD6, 2) + 0.7561 * Math.pow(AF6, 2) + 3.116
                * Math.pow(SEATW6, 2) + 1.211 * Math.pow(ELODT6, 2) - 0.4489
                * Math.pow(TAPER6, 2);
        double DOC6 = 83.260002 + 11.86 * CSPD6 - 0.0805 * AR6 - 0.0218
                ...
                * ELODT6 - 0.0007 * SEATW6 * TAPER6 + 0.0063 * ELODT6 * TAPER6
                - 10.77 * Math.pow(CSPD6, 2) - 0.288 * Math.pow(AR6, 2) - 0.288
                * Math.pow(SWEEP6, 2) + 5.182 * Math.pow(DPROP6, 2) - 0.2313
                * Math.pow(WINGLD6, 2) - 0.0895 * Math.pow(AF6, 2) - 0.2136
                * Math.pow(SEATW6, 2) - 0.2562 * Math.pow(ELODT6, 2) - 0.2686
                * Math.pow(TAPER6, 2);
        double ROUGH6 = 2.161 + 0.0007 * CSPD6 + 0.156 * AR6 - 0.0022 * SWEEP6
                ...
                * ELODT6 - 0.0001 * SEATW6 * TAPER6 + 0.0003 * ELODT6 * TAPER6
                - 0.0006 * Math.pow(CSPD6, 2) - 0.0255 * Math.pow(AR6, 2) - 0.0043
                * Math.pow(SWEEP6, 2) + 0.0039 * Math.pow(DPROP6, 2) + 0.0092
                * Math.pow(WINGLD6, 2) + 0.0014 * Math.pow(AF6, 2) + 0.0003
                * Math.pow(SEATW6, 2) - 0.0007 * Math.pow(ELODT6, 2) - 0.0052
                * Math.pow(TAPER6, 2);
        double WFUEL6 = 359.700012 - 5.78 * CSPD6 - 29.99 * AR6 + 0.0682
                ...
                * ELODT6 - 0.1262 * SEATW6 * TAPER6 + 0.1433 * ELODT6 * TAPER6
                - 0.8956 * Math.pow(CSPD6, 2) + 1.729 * Math.pow(AR6, 2) - 1.613
                * Math.pow(SWEEP6, 2) - 6.309 * Math.pow(DPROP6, 2) - 1.949
                * Math.pow(WINGLD6, 2) - 0.6581 * Math.pow(AF6, 2) - 2.723
                * Math.pow(SEATW6, 2) - 1.181 * Math.pow(ELODT6, 2) + 0.5244
                * Math.pow(TAPER6, 2);
        double PURCH6 = 44220 + 124.400002 * CSPD6 + 749.200012 * AR6 + 9.32
                ...
                * TAPER6 - 3.483 * ELODT6 * TAPER6 + 15.24 * Math.pow(CSPD6, 2)
                - 71.910004 * Math.pow(AR6, 2) + 33.990002 * Math.pow(SWEEP6, 2)
                + 60.540001 * Math.pow(DPROP6, 2) + 15.24 * Math.pow(WINGLD6, 2) + 28.49
                * Math.pow(AF6, 2) + 50.490002 * Math.pow(SEATW6, 2) + 18.190001
                * Math.pow(ELODT6, 2) - 9.011 * Math.pow(TAPER6, 2);
        double RANGE6 = 1932 - 6.389 * CSPD6 - 64.400002 * AR6 + 1.778 * SWEEP6
                ...
                * AF6 * ELODT6 + 6.873 * AF6 * TAPER6 - 3.928 * SEATW6 * ELODT6
                ...
                - 11.73 * Math.pow(CSPD6, 2) + 4.268 * Math.pow(AR6, 2) - 10.73
                * Math.pow(SWEEP6, 2) - 83.730003 * Math.pow(DPROP6, 2) + 39.27
                * Math.pow(WINGLD6, 2) - 7.232 * Math.pow(AF6, 2) - 14.23
                * Math.pow(SEATW6, 2) - 11.73 * Math.pow(ELODT6, 2) + 9.268
                * Math.pow(TAPER6, 2);
        double LDMAX6 = 17.34 + 0.4817 * CSPD6 + 1.573 * AR6 + 0.0179 * SWEEP6
                ...
                * ELODT6 - 0.0069 * SEATW6 * TAPER6 - 0.0037 * ELODT6 * TAPER6
                - 0.0838 * Math.pow(CSPD6, 2) - 0.1499 * Math.pow(AR6, 2) - 0.0058
                * Math.pow(SWEEP6, 2) + 0.0016 * Math.pow(DPROP6, 2) + 0.0214
                * Math.pow(WINGLD6, 2) + 0.0013 * Math.pow(AF6, 2) - 0.0337
                * Math.pow(SEATW6, 2) - 0.0133 * Math.pow(ELODT6, 2) + 0.0028
                * Math.pow(TAPER6, 2);
        double VCMAX6 = 197.100006 - 0.3331 * CSPD6 + 0.7564 * AR6 + 0.153
                ...
                * ELODT6 - 0.0462 * SEATW6 * TAPER6 - 0.028 * ELODT6 * TAPER6
                - 0.2315 * Math.pow(CSPD6, 2) - 0.384 * Math.pow(AR6, 2) - 0.013
                * Math.pow(SWEEP6, 2) + 0.315 * Math.pow(DPROP6, 2) - 0.612
                * Math.pow(WINGLD6, 2) + 0.206 * Math.pow(AF6, 2) - 0.2825
                * Math.pow(SEATW6, 2) - 0.1225 * Math.pow(ELODT6, 2) - 0.013
                * Math.pow(TAPER6, 2);
